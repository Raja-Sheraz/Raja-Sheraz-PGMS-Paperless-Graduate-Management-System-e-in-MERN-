...
router.get('/get_sudents_with_proposals/:teacher_id/:role', supervisorController.get_students_with_proposals)
...
router.post('/add_new_meeting',supervisorController.add_new_meeting)
