...
const StudentRegisterData = () => {
    ...
    return (
        <div>
            <div className="title3">Students Data</div>
                ...
                <tbody>
                    {currentStudents.map((student, index) => (
                        <tr key={index}>
                            ...
                            <td>
                                <button>
                                    <Link to={`/admin/admin/sendEmail/${student._id}`} style={{ color: '#7F3DD5' }}>
                                        <MdMarkEmailRead style={{ width: '40px', height: '40px',textAlign:'center' }} />
                                    </Link>
                                </button>
                            </td>
                            <td>
                                <Link to={`/admin/admin/update_Student/${student._id}`}>
                                    <button style={{ color: '#7F3DD5' }}>
