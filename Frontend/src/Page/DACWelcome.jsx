...
import Supervisor from '../pictures/DAC.png'

export default function DACWelcome() {
        ...
        <div className="welcome-container">
            <h1 className="welcomeh12">
                ...
                <span style={{ fontSize: '20px', color: 'white', fontWeight: 'normal' }}>
                    Always stay updated in your DAC Portal
                </span>
            </h1>
            <div className="image-containerd">
                <img src={Supervisor} alt="Student" className="student-image" />
            </div>
        </div>
    )
}
