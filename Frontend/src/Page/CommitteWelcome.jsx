...
import Supervisor from '../pictures/Committe.png'

export default function WelcomeCommitte() {
        ...
        <div className="welcome-container">
            <h1 className="welcomeh12">
                ...
                <span style={{ fontSize: '20px', color: 'white', fontWeight: 'normal' }}>
                    Always stay updated in your Committee Portal
                </span>
            </h1>
            <div className="image-containerc">
                <img src={Supervisor} alt="Student" className="student-imagec" />
            </div>
        </div>
    )
}
