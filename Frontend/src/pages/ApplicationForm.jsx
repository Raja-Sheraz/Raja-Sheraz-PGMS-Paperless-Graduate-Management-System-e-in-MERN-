...
function ApplicationForm() {
    ...
    let submitpaper = async () => {
        ...
        formData.append('pdf_type', 'application')
        formData.append('document_name', pdfname)
        formData.append('teacher_role', 'Supervisor')
        ...
        <div className="bg-neutral-100 h-screen w-screen overflow-hidden flex flex-row">
            ...
            <div className="flex flex-col flex-1">
                ...
                <div className="flex-1 p-4 min-h-0 overflow-auto">
                    <p>This application will be submitted to your supervisor</p>
                            ...
                            <div className="d-flex flex-column col-12 ">
                                <div className="col-12">
                                    <p style={{ fontStyle: 'italic', color: 'gray' }}>
                                        Selected file : {pdfref.current.files[0].name}
                                    </p>
                                    <div className="col-12">
